...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>About Srinivas Estate</h1>
      <p className='mb-4 text-slate-700'>Srinivas Estate is a leading real estate agency that specializes in 
      ...
      <p className='mb-4 text-slate-700'>
        ...
        experience , and we are dedicated to making that a reality for each one of our clients.
      </p>
    </div>
  )
}
